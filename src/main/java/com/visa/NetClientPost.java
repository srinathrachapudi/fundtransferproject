...
public class NetClientPost {
	...
	public String getResponse(String payload,String endpoint,String xpaytoken) throws SignatureException, IOException {
		...
		/* System.setProperty("https.proxyHost", (String)new ConfigValues().getPropValues().get("hostname"));
  		System.setProperty("https.proxyPort", (String)new ConfigValues().getPropValues().get("hostport"));
  		System.setProperty("https.proxyUser",(String)new ConfigValues().getPropValues().get("proxyusername"));
  		System.setProperty("https.proxyPassword", (String)new ConfigValues().getPropValues().get("proxypassword"));*/
